...
function ContactListM({ onSelectContact }) {
  ...
  return (
    <div className="contact-list font-Inter h-full">
      <div className="msg-header flex justify-between pt-[18px] pr-[15px] pl-[24px] pb-[16px] content-center">
        <p className="text-[24px] font-bold font-Inter">Messaging</p>
        ...
        {contacts.map((contact) => (
          <div
            ...
            onClick={() => {
              ...
              navigate.push(`/chat/${contact.id}`);
            }}
          >
            <div className="contact-whole flex justify-between pl-[18px] pt-[12px] pb-[22px]">
              ...
              <div className="contact-delivery text-[12px] font-light">
                <p>
                  {moment(
