...
const Recommended = () => {
  return (
    <div className="latest-wrapper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[60px]">
      <figure className="w-full md:w-80 bg-[#D4D4D4] hover:bg-white transition-all rounded-[10px]">
        <div className="w-full h-80 rounded-t-[10px] rounded-tr-[10px] mb-4 overflow-y-hidden">
          <img
            src={feauredImage}
            alt="featured image"
