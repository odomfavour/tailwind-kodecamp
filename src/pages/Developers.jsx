  ...
  return (
    <section>
      ...
      <div className=' w-[70%] container mx-auto'>
        <button className='w-[178px] h-[48px] text-[#FFFFFF] text-[16px] font-bold  bg-[#2776EA] mt-[90px] rounded-t-md'>
          Find a Candidate
        </button>
        <div className='bg-[#F5F5F5] p-4  flex flex-col md:flex-row  flex-wrap  items-center   gap-5 md:gap-11 '>
          <div className='relative'>
            ...
            <select className='px-6 py-4 w-[210px]'>
              <option className='m-auto'>Product Developer</option>
            </select>
          </div>
          ...
          <div className='relative'>
            ...
            <select className='px-11 py-4  w-[210px]'>
              <option className='p-9'>All</option>
            </select>
          </div>
          ...
          <div className='relative'>
            ...
            <select className='px-7  py-4  w-[210px]'>
              <option className='p-9'>Nigeria</option>
            </select>
          </div>
          ...
          return (
            <div key={id} className='w-[250px]'>
              ...
              <div className='w-[250px] mt-5 '>
                ...
                <h3 className='text-[16px] font-bold text-[#00000] '>
                  YEARS OF EXPERIENCE:{' '}
                  <span className=' text-[#2776EA]'>{experience}</span>
                </h3>
                <h3 className='text-[16px] font-bold text-[#00000] '>
      ...
      <button className='w-[227px] h-[64px]  py-5 justify-center border-[#2776EA] border-2 flex m-auto mt-[90px] mb-7'>
        See More
      </button>
    </section>
  );
