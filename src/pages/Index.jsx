    ...
    <MainLayout isLoggedIn={true}>
      <div className='main'>
        ...
        <div className='w-full mx-auto bg-[#D4E4FB] my-[100px] pt-8 pb-[60px]'>
          <div className='flex flex-col justify-center items-center gap-8'>
            <p className='font-bold text-[14px] text-[#08182F] md:text-[20px]'>
            ...
            <div className='w-5/6 flex justify-between items-center'>
              <img
                src={linkedInIcn}
                alt='LinkedIn'
                className='w-[20%] h-[20%] md:w-[10%] cursor-pointer'
              />
              <img
                src={microsoftIcn}
                alt='Microsoft'
              ...
              <img
                src={windowsIcn}
                alt='Windows'
                className='w-[20%] h-[20%] hidden md:block md:w-[10%] cursor-pointer'
              />
              <img
                src={facebookIcn}
                alt='Facebook'
              ...
              <img
                src={inTraxIcn}
                alt='inTrax'
                className=' w-[20%] h-[20%] md:w-[10%] md:h-[10%] cursor-pointer'
              />
              <img
                src={spotifyIcn}
                alt='Spotify'
        ...
        <div className='w-11/12 mb-20 mx-auto flex flex-col gap-0 items-center md:flex-row md:mb-40'>
          <div className='w-full items-center md:w-1/2'>
            <div className='w-full h-full'>
              <img
                src={imgOne}
                alt='image of people in a meeting'
          ...
          <div className='w-full md:w-1/2 py-8 flex flex-col'>
            ...
            <p className='text-[14px] w-5/6 font-normal mb-[50px] md:text-[22px]'>
              Let's match your recruiting needs with over 1000+ tech
              professionals, including designers, android developers, program
              managers, etc. Also, with Kodecamp, you can find the best
              candidates worldwide for positions like Data Scientists,
              Designers, Android Developers, etc. that meet your company's
              needs.
            </p>
            <button className='text-[14px] flex justify-center items-center bg-primaryBlue hover:bg-blue-700 font-normal text-white h-[50px] w-[200px] rounded-[5px] gap-3 md:text-[22px]'>
              Find an expert <FaChevronRight />{' '}
            </button>
          </div>
        </div>
        ...
        <div className='w-full mx-auto bg-[#D4E4FB] mb-28 py-24 md:mb-48'>
          <div className='w-11/12 mx-auto flex flex-col-reverse items-center md:flex-row'>
            <div className='w-full md:w-1/2 py-8 flex flex-col'>
              ...
              <p className='text-[14px] w-5/6 font-normal mb-[50px] md:text-[22px]'>
                At Kodecamp, we're committed to developing our IT talent and
                matching it with prospective customers and hiring managers.
                Additionally, over the past few years, we have had a 90% success
                rate in connecting our trainees with prospective customers and
                hiring managers from around the globe.
              </p>
              <button className='text-[14px] flex justify-center items-center bg-primaryBlue hover:bg-blue-700 font-normal text-white h-[50px] w-[200px] rounded-[5px] gap-3 md:text-[22px]'>
                Find an expert <FaChevronRight />{' '}
              </button>
      ...
      <div className='w-11/12 mx-auto flex  flex-col mb-20 md:flex-row md:mb-48'>
        ...
        <div className='w-full py-8 flex flex-col md:w-1/2'>
          <div className='flex items-center gap-4 mb-7'>
            <div className='border-l-[12px] border-[#2776EA] py-4'> </div>
            <h2 className='md:text-[40px] text-[26px] font-bold'>
              What We Do.
            </h2>
          </div>
          <p className='w-5/6 text-[14px] font-normal mb-[50px] md:text-[22px]'>
            At Kodecamp, we create successful client partnerships. We look for
            chances to organize training sessions for your staff. Our
            knowledgeable mentors are constantly accessible to help your
            employees train and develop their skills.
          </p>
          <button className='flex justify-center items-center bg-primaryBlue  hover:bg-blue-700 text-[14px] font-normal text-white h-[50px] w-[200px] rounded-[5px] gap-3 md:text-[22px]'>
        ...
        <div className='w-11/12 mx-auto'>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-4'>
            ...
            <div className='relative cursor-pointer'>
              <img
                className='w-full h-[352px] md:w-full md:h-fit '
                src={blogTwo}
                alt='image of codes'
              />
              <div className='bg-[#2b2b2b] opacity-90 text-[#fff] absolute bottom-0 left-0 w-full px-4 pb-10 pt-2'>
          ...
          <button className='mt-11 flex mx-auto justify-center items-center bg-primaryBlue hover:bg-blue-700 text-[14px] font-normal text-white h-[50px] w-[200px] rounded-[5px] gap-3 md:text-[22px]'>
