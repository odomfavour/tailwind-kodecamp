          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <div className="w-[230px] md:w-[700px] bg-[#F5F5F5] p-[24px] rounded text-[13px] md:text-[20px]">
                <p className="my-5">
                  At Trafford Technology, we are a diverse technology firm
                  focused on how to solve society and humanity problems with the
                  use of technology inclined solutions.
                </p>
                <p className="my-5">
                  ...
                  fastest software appication for E-payment, also designed
                  Robotic AI chips to help run machines without a driver due to
                  advance in motion sensitivity.
                </p>
                <p className="my-5">
                  Our staffs and Interns are people employed around the world,
                  which soem of them work full time, partime or remotely,
                  working 40 hours per week. We continue on our trend in
                  providing a sustainable world of AI eliminate human
                  limitations.
                </p>
              </div>
            </div>
